...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Snowball_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("88f46535-a3c0-54f4-998e-4320a1339f51"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Snowball", artifacts_toml) for e in artifacts["Snowball"]]
...
if best_platform === nothing
    @debug("Unable to load Snowball; unsupported platform $(triplet(platform_key_abi()))")
else
